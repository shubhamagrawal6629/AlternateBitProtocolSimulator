...
std::shared_ptr<cadmium::dynamic::modeling::model> repeater1 = cadmium::dynamic::translate::make_dynamic_atomic_model<Repeater, TIME>("repeater1");
...
std::shared_ptr<cadmium::dynamic::modeling::model> subnet3 = cadmium::dynamic::translate::make_dynamic_atomic_model<Subnet, TIME>("subnet3");
std::shared_ptr<cadmium::dynamic::modeling::model> subnet4 = cadmium::dynamic::translate::make_dynamic_atomic_model<Subnet, TIME>("subnet4");
...
cadmium::dynamic::modeling::Models submodels_Network = {subnet1, subnet2, repeater1, subnet3, subnet4};
cadmium::dynamic::modeling::EICs eics_Network = {
  cadmium::dynamic::translate::make_EIC<inp_1, subnet_defs::in>("subnet1"),
  cadmium::dynamic::translate::make_EIC<inp_2, subnet_defs::in>("subnet4"),
};
cadmium::dynamic::modeling::EOCs eocs_Network = {
  cadmium::dynamic::translate::make_EOC<subnet_defs::out,outp_1>("subnet2"),
  cadmium::dynamic::translate::make_EOC<subnet_defs::out,outp_2>("subnet3")
};
cadmium::dynamic::modeling::ICs ics_Network = {
  cadmium::dynamic::translate::make_IC<repeater_defs::ack_received_out, subnet_defs::in>("repeater1","subnet2"),
  cadmium::dynamic::translate::make_IC<subnet_defs::out, repeater_defs::packet_in>("subnet1","repeater1"),
  
  cadmium::dynamic::translate::make_IC<repeater_defs::packet_sent_out, subnet_defs::in>("repeater1","subnet3"),
  cadmium::dynamic::translate::make_IC<subnet_defs::out, repeater_defs::ack_in>("subnet4","repeater1")
};
...
cadmium::dynamic::modeling::ICs ics_ABPSimulator = {
  ...
  cadmium::dynamic::translate::make_IC<outp_1, sender_defs::ack_in>("Network","sender1"),
  cadmium::dynamic::translate::make_IC<receiver_defs::out, inp_2>("receiver1","Network"),
  cadmium::dynamic::translate::make_IC<outp_2, receiver_defs::in>("Network","receiver1")
};
